  ...
  window.VtexSearch = {
    ...
    start: function () {
      ...
      if (self.request === false) {
        $('body').trigger('vtexsearch.emptySearch', [ self.options ]);
    ...
    _createButtons: function () {
      ...
      $('.resultItemsWrapper div[id^=ResultItems]')
        .before('<a class="'+ self.options.classLoadLess +' '+ self.options.classLoadBtnHide +'">'+ self.options.textLoadLess +'</a>')
        .after('<a class="'+ self.options.classLoadMore +'">'+ self.options.textLoadMore +'</a>');
    },
    ...
    startWithoutCookie: function () {
      ...
      self.options.$result.trigger('vtexsearch.initWithoutCookie', [ self.options, self.request ]);
    ...
    bindFilters: function () {
      ...
      self.options.$filters.find('input').on('change', function (event) {
        ...
        self.options.$result.trigger('vtexsearch.beforeFilter', [ self.options, self.request, $label ]);
